...
import { Globe, Mail, Twitter, Instagram, Linkedin, MapPin } from "lucide-react";
import { Link } from "react-router-dom";
      ...
      <div className="flex flex-col gap-8 px-6 sm:px-8 py-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-8">
          ...
          <div className="shrink-0">
            ...
            <p className="text-on-surface-variant text-sm leading-relaxed max-w-sm">
              © 2026 ATC Africa. A powerhouse of change makers shaping the future of technology ecosystem in Africa.
            </p>

            <div className="flex items-center gap-2 mt-4 text-primary text-xl">
              <MapPin size={18} className="shrink-0 text-primary" />
              The HiveCreative Hub, Choba, Port Harcourt
            </div>
          </div>

          {/* Links */}
          <div className="flex flex-col gap-y-4">
            <a className="text-on-surface hover:text-primary text-sm" href="http://atcafrica.com" target="_blank" rel="noopener noreferrer">
              Join Community
            </a>

            <a className="text-on-surface hover:text-primary text-sm" href="https://drive.google.com/file/d/1WUCErMyao1Xxw9YfajUbqLKam91RfLvB/view" target="_blank" rel="noopener noreferrer">
              Sponsorship
            </a>

            <Link to="/tickets" className="text-on-surface hover:text-primary text-sm">
              Get Tickets
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <a className="text-on-surface hover:text-primary text-sm" href="mailto:hello@atcafrica.com">
              hello@atcafrica.com
            </a>

            <a className="text-on-surface hover:text-primary text-sm" href="https://atcafrica.com" target="_blank" rel="noopener noreferrer">
              atcafrica.com
            </a>
          </div>
        </div>
